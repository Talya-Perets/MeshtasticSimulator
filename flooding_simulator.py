...
class FloodingSimulator:
    """
    Flooding-only simulator class that avoids routing logic.
    Nodes forward to all neighbors except the sender and ignore duplicates.
    """
    def __init__(self):
        # Network instance
            ...
            if sender_node.pending_messages:
                ...
                for message, current_path, local_hop_limit in sender_node.pending_messages:
                   ...
                   # NEW: Use routing decision instead of flooding to all neighbors
                    valid_neighbors = list(sender_node.neighbors)
